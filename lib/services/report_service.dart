  ...
  static Future<void> exportVesselReport({
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          pw.Text(vessel.name, style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
          pw.SizedBox(height: 2),
          pw.Text(vessel.type, style: const pw.TextStyle(fontSize: 11, color: PdfColors.grey700)),
          ...
          pw.TableHelper.fromTextArray(
            headers: ['Tank', 'Category', 'Current (m³)', 'Capacity (m³)', 'Level', 'Status'],
            data: rows,
